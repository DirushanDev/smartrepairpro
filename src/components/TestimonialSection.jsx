...
const AVATARS = [
  "/src/assets/avatar-john.jpg",
  "/src/assets/avatar-sara.jpg",
  "/src/assets/avatar-liam.jpg",
];
...
export default function TestimonialSection() {
  ...
  return (
    <section aria-labelledby="testimonials-title">
      ...
      >
        {/* Overlay */}
        <div className="absolute inset-0 bg-[#e53935]/90"></div>

        {/* Content */}
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-28 text-center text-white">
          {/* Title */}
          <h2
          ...
          <div className="relative mt-12 sm:mt-16 lg:mt-20">
            ...
            {/* ⬇️ avatar now sits inside the card; overflow is clipped */}
            <div className="mx-auto max-w-5xl rounded-lg bg-white px-4 py-10 shadow-md sm:px-8 md:px-12 lg:px-16 overflow-hidden">
              {/* avatar + red quote badge */}
            ...
            {/* mobile arrows (stacked below card) */}
            <div className="mt-6 flex items-center justify-center gap-4 sm:hidden">
              <button
                onClick={prev}
                className="h-12 w-12 rounded bg-white text-black shadow hover:bg-gray-100"
                aria-label="Previous"
              >
                ‹
              </button>
